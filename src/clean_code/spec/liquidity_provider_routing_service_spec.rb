    ...
    describe ".determine_liquidity_provider" do
        ...
        context "when amount is less than 10K USD" do
            it "routes order to liquidity provider C" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_less_than_10000)
        ...
        context "when amount equals boundary value 9999 USD" do
            it "routes order to liquidity provider C" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_9999)
                expect(liquidity_provider).to be_instance_of(LiquidityProviderC)
            end
        end
        ...
        context "when amount equals boundary value 10K USD" do
            it "routes order to liquidity provider B" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_10000)
        ...
        context "when amount is bigger than 10K USD and less than 100K USD" do
            it "routes order to liquidity provider B" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_bigger_than_10000_less_than_100000)
                expect(liquidity_provider).to be_instance_of(LiquidityProviderB)
            end
        end
        ...
        context "when amount equals boundary value 99999 USD" do
            it "routes order to liquidity provider B" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_99999)
                expect(liquidity_provider).to be_instance_of(LiquidityProviderB)
            end
        end
        ...
        context "when amount equals boundary value 100000 USD" do
            it "routes order to liquidity provider A" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_100000)
        ...
        context "when amount is bigger than 100000 USD" do
            it "routes order to liquidity provider A" do
                liquidity_provider = LiquidityProviderRoutingService.determine_liquidity_provider(trade_order_bigger_than_100000)
                expect(liquidity_provider).to be_instance_of(LiquidityProviderA)
            end
        end
    end
